...
with open('apartments.csv', 'a') as f_csv:
    for _ in range(all_pages - 1):
        ...
        for link in range(1, count_links + 1):
            ...
            # Описание пока пхнул в конец, не разобрался как обзац делать при записи, \n в строке не конает.
            ...
            if flag_write_headrs:
                writer.writerow(keys)
                flag_write_headrs = False
    ...
    # датамаркер pagination-button/next
